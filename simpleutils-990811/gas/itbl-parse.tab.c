...
/*  A Bison parser, made from ../../binutils/gas/itbl-parse.y
...
#line 21 "../../binutils/gas/itbl-parse.y"
...
#line 283 "../../binutils/gas/itbl-parse.y"
typedef union 
  {
    char *str;
    int num;
...
case 4:
#line 311 "../../binutils/gas/itbl-parse.y"
{
    ...
    break;}
case 5:
#line 317 "../../binutils/gas/itbl-parse.y"
{
    ...
    break;}
case 12:
#line 336 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("ftype\n"));
    ...
    break;}
case 13:
#line 341 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("addr\n"));
	    yyval.num = ADDR;
	  ;
    break;}
case 14:
#line 346 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("immed\n"));
	    yyval.num = IMMED;
	  ;
    break;}
case 15:
#line 354 "../../binutils/gas/itbl-parse.y"
{
    ...
    break;}
case 16:
#line 363 "../../binutils/gas/itbl-parse.y"
{
	    yyval.val = yyvsp[-2].num | yyvsp[0].val;
	  ;
    break;}
case 17:
#line 367 "../../binutils/gas/itbl-parse.y"
{
	    yyval.val = yyvsp[-1].val;
	  ;
    break;}
case 18:
#line 371 "../../binutils/gas/itbl-parse.y"
{
	    yyval.val = yyvsp[0].num;
	  ;
    break;}
case 19:
#line 378 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("flags=%d\n", yyvsp[0].val));
    ...
    break;}
case 20:
#line 383 "../../binutils/gas/itbl-parse.y"
{
	    yyval.val = 0;
	  ;
    break;}
case 21:
#line 390 "../../binutils/gas/itbl-parse.y"
{
    ...
    break;}
case 22:
#line 396 "../../binutils/gas/itbl-parse.y"
{
	    sbit = 31;
	    ebit = 0;
	  ;
    break;}
case 23:
#line 404 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("pnum=%d\n",yyvsp[0].num));
	    yyval.num = yyvsp[0].num;
	  ;
    break;}
case 24:
#line 412 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("dreg\n"));
	    yyval.num = DREG;
	  ;
    break;}
case 25:
#line 417 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("creg\n"));
	    yyval.num = CREG;
	  ;
    break;}
case 26:
#line 422 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("greg\n"));
	    yyval.num = GREG;
	  ;
    break;}
case 27:
#line 430 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("name=%s\n",yyvsp[0].str));
    ...
    break;}
case 28:
#line 438 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("num=%d\n",yyvsp[0].num));
	    yyval.num = yyvsp[0].num;
	  ;
    break;}
case 29:
#line 446 "../../binutils/gas/itbl-parse.y"
{
	    DBGL2 (("val=x%x\n",yyvsp[0].num));
	    yyval.val = yyvsp[0].num;
	  ;
...
#line 451 "../../binutils/gas/itbl-parse.y"
