/* BFD back-end for SimpleScalar Extended-Coff files.
...
boolean ss_bfd_ecoff_set_arch_mach_hook PARAMS ((bfd *abfd, PTR filehdr));
...
static const struct ecoff_backend_data mips_ecoff_backend_data =
{
  /* COFF backend structure.  */
  {
    ...
    mips_ecoff_bad_format_hook, ss_bfd_ecoff_set_arch_mach_hook,
...
extern const bfd_target ss_coff_big_vec;

const bfd_target ss_coff_little_vec =
{
  "ss-coff-little",		/* name */
...
const bfd_target ss_coff_big_vec =
{
  "ss-coff-big",		/* name */
  bfd_target_ecoff_flavour,
...
boolean
ss_bfd_ecoff_set_arch_mach_hook (abfd, filehdr)
     bfd *abfd;
     PTR filehdr;
{
  struct internal_filehdr *internal_f = (struct internal_filehdr *) filehdr;
