/*
 * $Log: sstrix.h,v $
 * Revision 1.1  1994/01/20  16:16:52  austin
 * Initial revision
 *
 * $Id: sstrix.h,v 1.1 1994/01/20 16:16:52 austin Exp austin $
 */
...
#define SIMPLE_SCALAR_LITTLE

#ifndef CPP_PREDEFINES
#define CPP_PREDEFINES "\
-DSIMPLE_SCALAR \
-D__ANSI_COMPAT -DSSEL -DMIPSEL -DR3000 -DSYSTYPE_BSD -D_SYSTYPE_BSD \
-Dbsd4_2 -Dhost_simplescalar -Dhost_mips -Dsimplescalar -Dmips -Dultrix -Dunix \
-Asystem(unix) -Asystem(bsd) -Acpu(simplescalar) -Acpu(mips) \
-Amachine(simplescalar) -Amachine(mips)"
#endif
...
%{!mgas: \
	...
	%{gstabs:-g} %{gstabs0:-g0} %{gstabs1:-g1} \
	%{gstabs2:-g2} %{gstabs3:-g3} \
	%{gstabs+:-g} %{gstabs+0:-g0} %{gstabs+1:-g1} \
	%{gstabs+2:-g2} %{gstabs+3:-g3} \
	%{gcoff:-g} %{gstabs0:-g0} %{gcoff1:-g1} %{gcoff2:-g2} %{gcoff3:-g3}} \
%{G*} %{mgen-dl} %{mgen-ds} %{mgen-da}"
#endif
...
#ifndef MACHINE_TYPE
#define MACHINE_TYPE "SimpleScalar running sstrix"
#endif
