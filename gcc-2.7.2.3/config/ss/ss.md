;;
;; $Id: ss.md,v 1.3 1994/01/21 15:00:26 austin Exp austin $
;;

;;  Mips.md	     Machine Description for SS based processors
;;  Contributed by   A. Lichnewsky, lich@inria.inria.fr
;;  Changes by       Michael Meissner, meissner@osf.org
;;  Many hacks by    Todd Austin, austin@cs.wisc.edu
...
;; with the processor_type enumeration in ss.h.

;; Attribute describing the processor
;; (define_attr "cpu" "default,r3000,r6000,r4000"
;;   (const
;;    (cond [(eq (symbol_ref "ss_cpu") (symbol_ref "PROCESSOR_R3000"))   (const_string "r3000")
;;           (eq (symbol_ref "ss_cpu") (symbol_ref "PROCESSOR_R4000"))   (const_string "r4000")
;;           (eq (symbol_ref "ss_cpu") (symbol_ref "PROCESSOR_R6000"))   (const_string "r6000")]
;;          (const_string "default"))))

(define_attr "cpu" "default,r3000,r6000,r4000"
  (const (symbol_ref "ss_cpu_attr")))
...
(define_attr "branch_likely" "no,yes"
  (const
   (if_then_else (ge (symbol_ref "ss_isa") (const_int 2))
		 (const_string "yes")
		 (const_string "no"))))
...
(define_attr "abicalls" "no,yes"
  (const (symbol_ref "ss_abicalls_attr")))
...
;; Simple hack to recognize the "nor" instruction on the SS
...

;; Block moves, see ss.c for more details.
...
(define_insn "movstrsi_internal"
  [(set (match_operand:BLK 0 "memory_operand" "=To")	;; destination
	(match_operand:BLK 1 "memory_operand" "To"))	;; source
